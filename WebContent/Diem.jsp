...
<link href="https://fonts.googleapis.com/css?family=Arimo"
	...
	<link href="https://fonts.googleapis.com/css?family=Roboto"
        ...
        $(document).ready(function(){
        	$("#myModalhv").hide();
        	 $.get("act_Diem", function(responseJson) { 
        		...
        		//  act_HocVien là một servlet       
 		        ...
 		        $.each(responseJson, function(index, product) {  
 		            $("<tr>").appendTo($table)                     
 		                ...
 		                .append($("<td>").text(product.diem1)) 
 		                .append($("<td>").text(product.diem2)) 
 		                .append($("<td>").text(product.diemtb)) 
 		                .append($("<td>")
 		               		.append($("<a>")
 		                		.append($("<i>").addClass("fa fa-trash-o"))
 		                				...
 		                				.click(function(){
      		                					var retVal = confirm("Do you really want to delete this?");          	
    	 		           	                    if( retVal == true ){
    	 		           	                    $.post("act_Diem",{action: '4',maHocVien : product.maHocVien,maLop :product.maLop}, 
